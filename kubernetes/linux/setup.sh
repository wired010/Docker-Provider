...
if [ "${ARCH}" != "arm64" ]; then
    wget "https://github.com/microsoft/Docker-Provider/releases/download/official%2Fmdsd%2F1.25.0/azure-mdsd_1.25.0-build.master.476_x86_64.deb" -O azure-mdsd.deb
else
    wget "https://github.com/microsoft/Docker-Provider/releases/download/official%2Fmdsd%2F1.25.0/azure-mdsd_1.25.0-build.master.476_aarch64.deb" -O azure-mdsd.deb
fi
