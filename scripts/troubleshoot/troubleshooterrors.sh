...
contactUSMessage="Please contact us by creating a support ticket in Azure if you need any help with TroubleshootDump.log generated by this script. Use this link: https://azure.microsoft.com/en-us/support/create-ticket"
